      ...
      <div className="w-80 bg-gradient-to-b from-slate-50 to-slate-100 border-r border-slate-200 flex flex-col">
        ...
        <nav className="flex-1 p-4">
          <div className="space-y-1">
            ...
            <a href="#" className="flex items-center gap-3 p-3 rounded-xl bg-blue-600 text-white shadow-sm font-medium">
            ...
            <a href="/admin/blog" className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-100 text-slate-700 hover:text-slate-900 transition-all duration-200 font-medium">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="/admin/cabins/new" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors font-medium shadow-sm">
              +הוספת מקום חדש
            </a>
          </div>
        </div>
